...
<div x-show="open" x-transition:enter="transition ease-out duration-200"
  ...
  <div class="px-5 py-4 shadow-xl rounded-lg transform transition-all duration-300 scale-100 opacity-100">
    ...
    <span class="mr-3"><i class="fas fa-sign-in-alt text-gray-800"></i></span> <!-- Icono para inicio de sesión -->
    Inicio de sesión
    <span class="{{ request()->routeIs('login') ? 'block' : 'hidden' }} absolute bottom-0 left-0 right-0 h-1 bg-custom-color"></span>
</a>
<hr class="my-1">
...
<a href="{{ route('registro') }}" class="flex items-center px-4 py-3 rounded-lg text-lg font-medium"
    ...
    Crear nueva cuenta
    <span class="{{ request()->routeIs('registro') ? 'block' : 'hidden' }} h-1 bg-custom-color absolute bottom-0 left-0 right-0"></span>
</a>
<hr class="my-1">
...
<a href="{{ route('home') }}"
    ...
    <span class="mr-3"><i class="fas fa-home text-gray-800"></i></span> <!-- Icono para página de inicio -->
    Página de inicio
    <span class="{{ request()->routeIs('home') ? 'block' : 'hidden' }} h-1 bg-custom-color absolute bottom-0 left-0 right-0"></span>
</a>
